const menuItems = {
    Platitosasiaticos: [
        ...
        { name: "Langostinos Furai x4 unidades", description: "Langostinos rebozados en cereal acompañados de mayo spicy", price: "$14000", image: "https://images.unsplash.com/photo-1582450871972-ab5ca641643d?w=400&h=300&fit=crop" },
    ...
    Gohan: [
        { name: "Ghoan Akira log de algo", description: "Base de arroz de sushi, queso philadelphia, palta, salmon fresco, verdeo, hanikama rebozado, calamar crispy", price: "$18999", image: "https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400&h=300&fit=crop" },
    ...
    Platos: [
        { name: "Cerdo coreno ", description: "Cubos de cerdo cocinados en salsa gochujang,miso y salsa de ostras acompañado de verduras, arroz y yema ahumada", price: "$18999", image: "https://images.unsplash.com/photo-1585032226651-759b368d7246?w=400&h=300&fit=crop" },
        { name: "Ceviche logo ", description: "Cortes de salmon y langostinos, cebolla en pluma, tomate, pepino y masa wonton crocante en leche de tigre", price: "$16000", image: "https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=400&h=300&fit=crop" },
        { name: "Ramen Cremoso logo", description: "Caldo assari cremoso de pollo y langostinos, fideos alcalinos,ajitama, chashu, langostinos, verdeo, aceite de ajo negro", price: "$17000", image: "https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&h=300&fit=crop" },
